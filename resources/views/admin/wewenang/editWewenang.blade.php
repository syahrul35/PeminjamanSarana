...
<body class="bg-gray-100 text-gray-900 tracking-wider leading-normal m-4 my-4 justify-center">
    ...
    <section class="w-full lg:w-4/5">
        ...
        <!--Title-->
        <h2 class="font-sans font-bold break-normal text-gray-700 px-2 pb-8 text-xl">Edit Wewenang</h2>

        <!--Card-->
        <div id='section2' class="p-8 mt-6 lg:mt-0 rounded shadow bg-white">

            <form action="{{ route('updateWewenang', $wewenang) }}" method="POST">
                @csrf
                @method('PATCH')
                <!-- {{ csrf_field() }}
                {{ method_field('PATCH') }} -->
                ...
                <div class="md:flex mb-4">
                    ...
                    <div class="md:w-2/3">
                        <input class="form-input block w-full focus:bg-white" id="jabatan_wewenang" type="text" value="{{$wewenang->jabatan_wewenang}}" name="jabatan_wewenang">
                    </div>
                </div>
                ...
                <div class="md:flex mb-4">
                    ...
                    <div class="md:w-2/3">
                        <input class="form-input block w-full focus:bg-white" id="telp_wewenang" type="text" value="{{$wewenang->telp_wewenang}}" name="telp_wewenang">
                    </div>
                </div>
