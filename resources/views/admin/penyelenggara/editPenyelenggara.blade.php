...
<body class="bg-gray-100 text-gray-900 tracking-wider leading-normal m-4 my-4 justify-center">
    ...
    <section class="w-full lg:w-4/5">
        ...
        <div id='section2' class="p-8 mt-6 lg:mt-0 rounded shadow bg-white">
            ...
            <form action="{{ route('updatePenyelenggara', $user) }}" method="POST">
                @csrf
                @method('PATCH')
                <!-- {{ csrf_field() }}
                {{ method_field('PATCH') }} -->
                <div class="md:flex mb-4">
                    ...
                    <div class="md:w-2/3">
                        <input class="form-input block w-full focus:bg-white" id="name" type="text" value="{{$user->name}}" name="name">
                    </div>
                </div>
                ...
                <div class="md:flex mb-4">
                    ...
                    <div class="md:w-2/3">
                        <input class="form-input block w-full focus:bg-white" id="email" type="email" value="{{$user->email}}" name="email">
                    </div>
                </div>
                ...
                <div class="md:flex md:items-center">
                    ...
                    <div class="md:w-1/3">
                        <a href="/admin/kelolaPenyelenggara">
