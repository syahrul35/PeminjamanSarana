...
<body class="bg-gray-100 text-gray-900 tracking-wider leading-normal m-4 my-4 justify-center">
    ...
    <section class="w-full lg:w-4/5">
        ...
        <!--Title-->
        <h2 class="font-sans font-bold break-normal text-gray-700 px-2 pb-8 text-xl">Tambah Penyelenggara</h2>

        <!--Card-->
        <div id='section2' class="p-8 mt-6 lg:mt-0 rounded shadow bg-white">

            <form action="{{ route('simpanPenyelenggara') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="md:flex mb-4">
                    ...
                    <div class="md:w-2/3">
                        <input class="form-input block w-full focus:bg-white" id="name" type="text" value="" name="name">
                    </div>
                </div>
                ...
                <div class="md:flex mb-4">
                    ...
                    <div class="md:w-2/3">
                        <input class="form-input block w-full focus:bg-white" id="email" type="email" value="" name="email">
                    </div>
                </div>
                ...
                <div class="md:flex mb-4">
                    ...
                    <div class="md:w-2/3">
                        <input class="form-input block w-full focus:bg-white" id="password" type="password" value="" name="password">
                    </div>
                </div>
