        ...
        <div class="overflow-x-auto shadow-md sm:rounded-lg">
            <table class="w-full text-sm text-left text-gray-700 dark:text-gray-400">
                ...
                <tbody>              
                    ...
                    <tr class="{{ $results[0] > $results[1] ? 'bg-emerald-500 text-dark-eval-2' : 'bg-white dark:bg-gray-800' }} border-b text-center">
        ...
        <div class="overflow-x-auto shadow-md sm:rounded-lg">
            <table class="w-full text-sm text-left text-gray-700 dark:text-gray-400">
                ...
                <tbody>              
                    ...
                    <tr class="{{ $results[1] > $results[0] ? 'bg-emerald-500 text-dark-eval-2' : 'bg-white dark:bg-gray-800' }} border-b text-center">
                        <td class="px-6 py-4">{{ $loop->iteration }}</td>
                        <td class="px-6 py-4">{{ $event->name }}</td>
                        <td class="px-6 py-4">{{ $event->nama_event }}</td>
                        <td class="px-6 py-4">{{ $event->nama_sarpras }}</td>
